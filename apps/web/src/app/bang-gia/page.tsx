...
export const metadata: Metadata = { title: "Bảng giá", description: "Bảng giá sản phẩm AIVisionary hiển thị bằng VND." };
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 20 }}>
        {catalog.products.map((product) => (
          <article key={product.id} className="glass-panel" style={{ borderRadius: 16, padding: 22 }}>
            ...
            <LinkButton href={`/san-pham/${product.slug}`}>Xem gói</LinkButton>
          </article>
        ))}
      </div>
    </section>
